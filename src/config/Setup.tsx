...
export const steps = [
  ...
  {
    id: 3,
    title: 'Editors & UI Library',
    icon: '🛠️',
    content: [
      { type: 'instruction', text: 'Install Cursor (AI-first editor) for faster dev.' },
      { type: 'instruction', text: 'Install Visual Studio Code.' },
      { type: 'instruction', text: 'Use shadcn/ui for consistent, accessible components.' },
    ],
  },
];
