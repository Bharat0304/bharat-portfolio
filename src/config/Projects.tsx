...
export const projects: Project[] = [
  {
    ...
    link: 'https://github.com/Bharat0304/Proofly',
    github: 'https://github.com/Bharat0304/Proofly',
    live: '#',
    details: false,
  ...
  },
  {
    ...
    link: 'https://github.com/Bharat0304/holoverse.git',
    github: 'https://github.com/Bharat0304/holoverse.git',
    live: '#',
    details: false,
    projectDetailsPageSlug: '#',
    isWorking: true,
  },
  {
    ...
    image: '/projects/workspaceai.png',
    technologies: [
      { name: 'React', icon: <ReactIcon key="react" /> },
      { name: 'Node.js', icon: <NodeJs key="nodejs" /> },
      { name: 'TypeScript', icon: <TypeScript key="typescript" /> },
    ],
    link: 'https://github.com/Bharat0304/Workspace-ai',
    github: 'https://github.com/Bharat0304/Workspace-ai',
    live: '#',
    details: false,
    projectDetailsPageSlug: '#',
    isWorking: true,
  },
  {
    ...
    image: '/projects/CounselPlus.png',
    technologies: [
      { name: 'React', icon: <ReactIcon key="react" /> },
      { name: 'Node.js', icon: <NodeJs key="nodejs" /> },
      { name: 'Express.js', icon: <ExpressJs key="expressjs" /> },
