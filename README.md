# Bharat Kumar — Portfolio

A modern, responsive portfolio website for Bharat Kumar (Full-Stack Developer) built with Next.js 15, TypeScript, Tailwind CSS, and Shadcn UI. Features a project showcase, experience, and contact. Blog is “Coming Soon”.
...
- **Dark/Light** mode
- **Responsive** design
- **Project details** via configurable cards
- **Contact Form** (notifications currently disabled)
- **SEO** optimized
- **TypeScript** for type safety
- Optional analytics support (Umami)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Bharat0304/portfolio.git
   cd portfolio
   ```
